		...
		\begin{subequations}
			\begin{align}
				\int_{\eR}(\partial_ng)(a+te_n)dt & = \int_{\eR}h'(t)dt                                                               \\
				                                  & =\lim_{R\to\infty}\int_{-R}^Rh'(t)dt      & \prop{PROPooSBKEooOlxqRk}             \\
				                                  & =\lim_{R\to \infty}\Big( h(R)-h(-R) \Big) & \theo{ThoRWXooTqHGbC}                 \\
				                                  & =0.
			\end{align}
		\end{subequations}
...
%-------------------------------------------------------
\subsection{Dérivation dans le bornes}
%----------------------------------------------------
...
Cet exemple sera rendu rigoureux par les propositions \ref{PROPooUMIPooQGXaPd} et \ref{PropJLnPpaw}.
